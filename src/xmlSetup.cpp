...

{
    ...
    for(int i = 0; i < nOfQuads; i++)
    {
        ...
        #ifdef WITH_KINECT
            #ifdef WITH_SYPHON
            quads[i].setup(x0, y0, x1, y1, x2, y2, x3, y3, edgeBlendShader, quadMaskShader, chromaShader, brickShader, cameras, models, sharedVideos, kinect, syphClient, sharedSampler);
            #else
            quads[i].setup(x0, y0, x1, y1, x2, y2, x3, y3, edgeBlendShader, quadMaskShader, chromaShader, brickShader, cameras, models, sharedVideos, kinect, sharedSampler);
            #endif
        #else
            #ifdef WITH_SYPHON
            quads[i].setup(x0, y0, x1, y1, x2, y2, x3, y3, edgeBlendShader, quadMaskShader, chromaShader, brickShader, cameras, models, sharedVideos, syphClient, sharedSampler);
            #else
            quads[i].setup(x0, y0, x1, y1, x2, y2, x3, y3, edgeBlendShader, quadMaskShader, chromaShader, brickShader, cameras, models, sharedVideos, sharedSampler);
            #endif
        #endif
